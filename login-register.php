                        ...
                        switch ($action) {
                            ...
                            case 'forget-password-mobile':
                                if (settingsController::getInstance()->get_option('enable-sms', 0) == 1) {
                                    if (!$step) {
                                        require_once get_parent_theme_file_path('templates/auth/forget-password-mobile-form-step1.php');
                                    } else {
                                        require_once get_parent_theme_file_path('templates/auth/forget-password-mobile-form-step2.php');
                                    }
                                }
                                break;
