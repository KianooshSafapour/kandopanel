...
<div class="samyar-settings wrap">
    <div class="uk-margin">
        <div class="uk-alert-danger" uk-alert>
            ...
            <p class="samyar-menu-item"><b>توجه:</b> لطفا قبل از اعمال تنظیمات به بخش <a data-toggle="help" href="<?= admin_url('admin.php?page=samyar-settings#help') ?>">راهنما</a> برید و راهنما و سوالات متداول رو مشاهده نمایید </p>
            </p>
        </div>
    </div>
...
//					include( SAMYAR_DIR_TEMPLATE . '/settings/styles.php' );
					...
					include( SAMYAR_DIR_TEMPLATE . '/settings/representation.php' );
