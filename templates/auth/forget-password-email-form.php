...
?>
<form class="form w-100" id="kt_password_reset_form" novalidate="novalidate">
    <?php wp_nonce_field('forgot_password_nonce', 'forgot_password_nonce'); ?>
    <input type="hidden" name="action" value="kandopanel_forgot_password">
    <!--begin::Heading-->
    <div class="text-center mb-10">
        ...
        <!--end::Title-->
        <!--begin::Link-->
        <div class="text-gray-500 fw-semibold fs-6"><?php _e('please enter your Email',SAMYAR_TEXT_DOMAIN)?></div>
        <!--end::Link-->
    </div>
    <!--begin::Heading-->
    <!--begin::Input group=-->
    ...
    <div class="d-flex flex-wrap justify-content-center pb-lg-0">
        <button type="submit" id="kt_password_reset_submit" class="btn btn-primary me-4">
            ...
            <span class="indicator-label"><?php _e('Send recovery link',SAMYAR_TEXT_DOMAIN)?></span>
            <!--end::Indicator label-->
