...
if ($mobile) {
    ?>
    <form class="form w-100" id="kt_password_reset_by_mobile2_form" novalidate="novalidate">
        <?php wp_nonce_field('forgot_password_by_mobile2_nonce', 'forgot_password_by_mobile2_nonce'); ?>
        <input type="hidden" name="action" value="kandopanel_verify_forgot_password">
        ...
        <div class="d-flex flex-wrap justify-content-center pb-lg-0">
            <button type="submit" id="kt_forget_verify_code_submit" class="btn btn-primary me-4">
