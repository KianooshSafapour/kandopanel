                ...
                <div class="samyar-settings-area samyar-settings-change-log" style="display:block">
                    ...
                    <div class="samyar-other-products uk-overflow-auto">
                        ...
                        <ul class="uk-list uk-list-bullet">
                            ...
                            <li>امکان فعالسازی ورود دو مرحله ای برای پیشخوان وردپرس هم فراهم شد </li>
                            <li>تغییر رمز عبور با کد یکبار مصرف از طریق ایمیل اضافه شد </li>
                            <li>از این پس می تونید نام سرویس و دسته و توضیحاتشون و همچنین برندها رو چند زبانه کنید (در افزودن و ویرایش)  </li>
                            <li>اضافه شدن شورتکد [api_documents] برای نمایش مستندات api در هر برگه ای</li>
                            <li>مدیریت پایگاه داده کندوپنل به بخش زیر منوی تنظیمات کندوپتل اضافه شد</li>
                            ...
                            <li>امنیت ورود بهبود پیدا کرد و اگر کاربر 5 بار تلاش ناموفق کنه به مدت 15 دقیقه قفل میشه</li>
                            <li>برای امنیت بیشتر کاربری غیر از مدیر اگر بخش پیشخوان وردپرس رو باز کنه به صفحه اصلی هدایت میشه</li>
                            <li>تراکنش های افزایش اعتبار به بخش افزایش اعتبار زیر باکس افزایش اعتبار اضافه شده و نمایش تراکنش به روش قدیمی به جاش در بخش تراکنش ها برای مدیر و کاربر قرار گرفت</li>
