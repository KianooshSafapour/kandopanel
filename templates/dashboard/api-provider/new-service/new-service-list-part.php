    ...
    <div class="dashboard-posts-box dashboard-tickets-box" style="margin-top: 10px">
        <div class="dashboard-posts-title-holder">
            <h5 class="dashboard-posts-title">
                <input type="checkbox" value="1" class="kando-cb-checkbox" id="cb-select-category-<?= $c ?>" name="cb-select-category-<?= $c ?>">
                <label class="kando-cb-label" for="cb-select-category-<?= $c ?>"></label>
            </h5>
            <h5 class="dashboard-posts-title"><?php echo date_i18n('Y-m-d',strtotime($date)) ?></h5>
        </div>
        <div class="dashboard-posts-list">
            ...
            if ($services):
                ...
                <table class="shop_table shop_table_responsive">
                    ...
                    <tr>
                        <th id="cb">
<!--                            <input type="checkbox" value="1" class="kando-cb-checkbox" id="cb-select-category---><?php //= $c ?><!--"-->
<!--                                   name="cb-select-category---><?php //= $c ?><!--">-->
<!--                            <label class="kando-cb-label" for="cb-select-category---><?php //= $c ?><!--"></label>-->
                        </th>
                            ...
                            <td data-title="<?php _e('Description', SAMYAR_TEXT_DOMAIN); ?>">
                                <?php if (isset($service['desc']) && $service['desc']):
                                    ...
                                    <span class="kt-modal-button button button-default samyar-show-description-service-local"
                                          ...
                                          data-desc="<?php echo esc_html($description) ?>">توضیحات</span>
