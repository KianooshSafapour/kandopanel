...
<div class="tickets-navigation">
    <a href="#" class="button button-blue kando-show-payment-filter"
            ...
            <div class="clearfix">
                ...
                <div class="column kt-col-xs-6 kt-col-md-3 float-right">
                    ...
                    <label style="margin: 20px 0;font-size: 15px;font-weight: bold;" class="publish-notification"
                           for="success-status"><?php _e("Only Successful Ones", SAMYAR_TEXT_DOMAIN); ?></label>
                </div>
                <div class="column kt-col-xs-6 kt-col-md-3 float-right">
                    ...
                    <label style="margin: 20px 0;font-size: 15px;font-weight: bold;" class="publish-notification"
                           for="success-add-credit"><?php _e("Only Deposits", SAMYAR_TEXT_DOMAIN); ?></label>
                </div>
            </div>
        </form>
    </div>
        ...
        <li class="list-inline-item nav-select" style="margin-left: -5px;">
            <a class="nav-link <?= (!isset($_GET['section'])) ? 'active' : '' ?>"
               href="<?= home_url('dashboard/?action=payments') ?>">
                ...
                echo '<span class="button button-light badge-error-orders">' . get_count_payments_all('all') . '</span>' ?></a>
        </li>
        <?php
                    ...
                    <tr id="order-<?php echo esc_attr($payment->id) ?>">
                        <td data-title="<?php _e("Type", SAMYAR_TEXT_DOMAIN); ?>">
                            <?php if ($payment->status == 1): ?>
                                ...
                                <?php elseif ($payment->payment_type == "$user_id"): ?>
