                    ...
                    <div class="kt-row">
                        <div class="column kt-col-xs-12 kt-col-md-12">
                            <div class="new-api-form-outer">
                                ...
                                <form class="samyar-form" id="2fa-generate-form" method="POST" autocomplete="off" style="<?php if ($twofa_code_sent) { ?>display: none;<?php } else { ?>display: block;<?php } ?>">
                                    ...
                                    <div class="alert alert-warning" role="alert" style="font-size: 14px;">
                                        <?php _e('Email-based option to add an extra layer of protection to your account. When signing in you’ll need to enter a code that will be sent to your email address.', SAMYAR_TEXT_DOMAIN); ?>
                                    </div>
                                    <p style="margin-top:10px">
                                ...
                                <form class="samyar-form" id="2fa-approve-form" method="POST" autocomplete="off" style="<?php if ($twofa_code_sent) { ?>display: block;<?php } else { ?>display: none;<?php } ?>">
                                    <input type="hidden" name="action" value="kando_2fa_approve">
                                    <input type="hidden" name="enabled" value="<?= $twofa_enabled ? '0' : '1' ?>">
                                    <?php wp_nonce_field('2fa_approve_nonce', '2fa_approve_nonce'); ?>
                                    <div class="samyar-form-loading"></div>
                                    <div class="alert alert-warning" role="alert" style="font-size: 14px;">
                                        <?php _e('Please check your email and enter the code below.', SAMYAR_TEXT_DOMAIN); ?>
                                    </div>
