...
<div class="kt-row">
    ...
    <div class="column kt-col-xs-12 kt-col-md-7 float-left">
        <div class="new-api-form-outer">
            <h4 class="new-ticket-title"><?php _e("Add New Tag", SAMYAR_TEXT_DOMAIN); ?></h4>
            ...
            <form method="POST" class="samyar-form new-tag-form">
                <input type="hidden" name="action" value="samyar_tag_add">
                ...
                <div class="clearfix">
                    ...
                    <select name="background_color" id="background_color">
                        ...
                        <?php foreach (service_tags_color() as $key => $color): ?>
                            <option value="<?php echo esc_attr($key) ?>"><?php echo esc_attr($color['name']) ?></option>
                        <?php endforeach; ?>
                    </select>
