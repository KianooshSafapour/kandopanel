...
<div class="tickets-navigation">
    ...
    <?php if (kando_user_can('add_service')): ?>
        <a href="<?php echo esc_attr(home_url('dashboard/?action=services&section=new')) ?>" class="button button-light"
           data-wpel-link="internal">افزودن سرویس</a>
    <?php endif; ?>
    <?php if (kando_user_can('edit_service')): ?>
        ...
        <a href="<?php echo esc_attr(home_url('dashboard/?action=services&section=all&active=0')) ?>"
           style="float: left;margin-right: 5px" class="button button-red" data-wpel-link="internal">سرویس های غیر
            فعال</a>
        <a href="<?php echo esc_attr(home_url('dashboard/?action=services&section=all&active=1')) ?>"
           style="float: left;margin-right: 5px" class="button button-green" data-wpel-link="internal">سرویس های
            فعال</a>
    <?php endif; ?>
    <a href="#" class="button button-blue kando-show-services-search"
       data-wpel-link="internal"><?php _e("Search", SAMYAR_TEXT_DOMAIN); ?></a>
</div>
<div class="kt-row">
            ...
            <div class="clearfix">
                <div class="column kt-col-xs-12 kt-col-md-10 float-right">
                    <input type="text" name="search"
                           placeholder="<?php _e("Enter part of the title and press enter", SAMYAR_TEXT_DOMAIN); ?>">
                </div>
                <div class="column kt-col-xs-12 kt-col-md-2 float-right">
                    <input type="submit" class="button button-green sen" style="height: 46px;"
        ...
        <div class="dashboard-posts-box dashboard-tickets-box">
            <div class="dashboard-posts-title-holder">
                <h5 class="dashboard-posts-title">
                    ...
                    <?php if ($cat['category_status'] === "0"): ?><span
