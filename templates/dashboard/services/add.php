            ...
            <div class="kt-col-xs-12 service-rate not-free" style="margin-top:15px;">
                ...
                <div class="kt-col-xs-4 kt-col-md-4">
                    ...
                    echo sprintf(
                        ...
                        kando_get_currency_base_text(true)
                    );
                    ?>
                </div>
                <div class="kt-col-xs-4 kt-col-md-4">
            ...
            if ($representation_active) {
                ...
                <div class="representation-rates not-free">
                    <div class="kt-col-xs-12 service-rate not-free" style="margin-top:15px;">
                        ...
                        <div class="kt-col-xs-4 kt-col-md-4">
                            <?php _e("Price (", SAMYAR_TEXT_DOMAIN); ?><?php kando_get_currency_base_text(true) ?><?php _e(")", SAMYAR_TEXT_DOMAIN); ?>
                        </div>
                        <div class="kt-col-xs-4 kt-col-md-4">
                    ...
                    <?php foreach ($representation_rates as $key => $rate) { ?>
                        <div class="kt-col-xs-12 service-rate pt13">
                            ...
                            <div class="service-rate-padding kt-col-xs-4 kt-col-md-4">
                                <input type="number" name="<?= $key ?>_profit_rate" placeholder="<?php _e("Discount", SAMYAR_TEXT_DOMAIN); ?>"
                                       value=""/>
                            </div>
