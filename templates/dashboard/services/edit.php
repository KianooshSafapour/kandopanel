        ...
        <form method="POST" class="samyar-form new-service-form">
            <div class="column kt-col-xs-12 kt-col-md-5 float-left">
                ...
                <div class="kt-col-xs-12 service-rate not-free"
                    ...
                    <div class="kt-col-xs-5 kt-col-md-5">
                        <?php
                        echo sprintf(
                ...
                <div class="kt-col-xs-12 service-rate not-free"
                    ...
                    <div class="service-rate-padding kt-col-xs-5 kt-col-md-5">
                    ...
                    <div class="service-rate-padding kt-col-xs-5 kt-col-md-5">
                        <input type="number" name="profit_rate" placeholder="<?php _e("Profit Rate", SAMYAR_TEXT_DOMAIN); ?>"
                               value="<?php echo esc_attr($service->profit_rate) ?>"/>
                    </div>
...
-->
                        ...
                        <input type="number" min="0" max="100" name="gift-percent-quantity" value="<?php echo $service->gift_percent_quantity ?>" placeholder="<?php _e('Percentage', SAMYAR_TEXT_DOMAIN); ?>"/>
