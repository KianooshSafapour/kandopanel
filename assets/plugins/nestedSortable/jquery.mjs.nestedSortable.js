    ...
    $.widget("mjs.nestedSortable", $.extend({}, $.ui.sortable.prototype, {
        ...
        toArray: function(options) {
            ...
            function _recursiveArray(item, depth, _left) {
                ...
                // console.log(o.expression);
                // id = ($(item).attr(o.attribute || "id") || "").match(o.expression || (/(.+)[-=_](.+)/));//remove by morteza
                id = ($(item).attr(o.attribute || "id") || "");//add by morteza
                ...
                if (depth === sDepth) {
                    ...
                    pid = ($(item).parent(o.listType)
                        .parent(o.items)
                        .attr(o.attribute || "id"));
                        // .match(o.expression || (/(.+)[-=_](.+)/));//remove by morteza
                    // pid = parentItem[2];
                }
