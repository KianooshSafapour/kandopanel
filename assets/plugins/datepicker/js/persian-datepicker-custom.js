(function (jQuery) {
    var current_calendar = "persian";//persian
    var calendar_separator = "-";
    var calendar_format = "YYYY" + calendar_separator + "MM" + calendar_separator + "DD";
    var calendar_persian_format = "YYYY" + calendar_separator + "MM" + calendar_separator + "DD";
    var year_index = 0;
    var month_index = 0;
    var day_index = 0;
    var calendar_split = calendar_format.split(calendar_separator);
    for (var i = 0; i < calendar_split.length; i++) {
        if (calendar_split[i] == "DD")
            day_index = i;
        else if (calendar_split[i] == "MM")
            month_index = i;
        else if (calendar_split[i] == "YYYY")
            year_index = i;
    }
    ...
    var customTemplate = "\n<div id=\"plotId\" class=\"datepicker-plot-area {{cssClass}}\">\n" +
        ...
        "                    }\n" +
        "                });</script>";
    jQuery.fn.advancedDatepicker = function (options) {
		...
		if(options == "getDate") {
			...
			var defaults = {
				...
				altFieldFormatter: function (unixDate) {
					return moment(unixDate).format(calendar_format);
				}
			};
