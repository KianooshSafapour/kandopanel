...
<div class="wrapper blog-page-posts-outer">
    ...
    <div class="masonry-size masonry-item kt-col-md-4 kt-col-sm-6 kt-col-xs-12"><?php  echo $wp_query->found_posts . " مورد یافت شد"; ?></div>
    <?php endif; ?>
						...
						<div class="blog-image-holder">
							<?php if ( has_post_thumbnail() ): ?>
								<a href="<?php the_permalink(); ?>" data-wpel-link="internal">
									<?php the_post_thumbnail(array(925, 397), [ 'class' => 'kt-lazyload', 'data-src' => get_the_post_thumbnail_url() ] ); ?>
								</a>
							<?php endif; ?>
						</div>
